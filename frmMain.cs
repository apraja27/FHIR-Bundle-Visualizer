...
namespace FHIR_Bundle_Visualizer
{
	public partial class frmMain : Form
	{
		...
		public void ReInitializeValues()
		{
			...
			labelNHS.Text = string.Empty;
			labelPatientName.Text = string.Empty;
			labelBornDetails.Text = string.Empty;
		}
		...
		public void SetPatientDetails(Bundle bundle)
		{
			...
			if (patientDetails != null)
			{
				...
				labelNHS.Text = patientDetails.NHS;
				labelBornDetails.Text = patientDetails.BornDetail;
			}
		}
		...
		public Bundle DeserializeFromString(string jsonString)
		{
			...
			{
				if (!ex.StackTrace.Contains("ExceptionSourceExtensions.NotifyOrThrow"))
				{
					throw ex;
				}
			}
		...
		private void btnBrowse_Click(object sender, EventArgs e)
		{
			...
			if (fileSelected && txtFilePath.Text.Length > 0)
			{
				...
				catch (Exception ex)
				{
					...
					MessageBox.Show("Unable to read selected file. error found at " + ex.Message, "FHIR Bundle Visualizer", MessageBoxButtons.OK, MessageBoxIcon.Information);
				}
				finally
				{
